...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public void __Gen_Delegate_Imp15(UnityEngine.Font p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp16(bool p0, bool p1, int p2)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public char __Gen_Delegate_Imp17(string p0, int p1, char p2)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public float __Gen_Delegate_Imp18(UnityEngine.UI.ILayoutElement p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
		    ...
		    if (type == typeof(PerformanceMono.LuaCallPerfCase))
			{
			    return new PerformanceMono.LuaCallPerfCase(__Gen_Delegate_Imp0);
			}
			...
			{
			    return new System.Action<UnityEngine.Font>(__Gen_Delegate_Imp15);
			}
		
		    if (type == typeof(System.Action<bool, bool, int>))
			{
			    return new System.Action<bool, bool, int>(__Gen_Delegate_Imp16);
			}
		
		    if (type == typeof(UnityEngine.UI.InputField.OnValidateInput))
			{
			    return new UnityEngine.UI.InputField.OnValidateInput(__Gen_Delegate_Imp17);
			}
		
		    if (type == typeof(System.Func<UnityEngine.UI.ILayoutElement, float>))
			{
			    return new System.Func<UnityEngine.UI.ILayoutElement, float>(__Gen_Delegate_Imp18);
			}
