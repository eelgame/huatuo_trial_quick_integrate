...
namespace XLua
{
	...
	internal partial class InternalGlobals
    {
		...
		delegate int __GEN_DELEGATE8( UnityEngine.ParticleSystem ps);
		
		delegate int __GEN_DELEGATE9( UnityEngine.ParticleSystem ps,  UnityEngine.GameObject go,  System.Collections.Generic.List<UnityEngine.ParticleCollisionEvent> collisionEvents);
		
		delegate int __GEN_DELEGATE10( UnityEngine.ParticleSystem ps,  UnityEngine.ParticleSystemTriggerEventType type);
		
		delegate int __GEN_DELEGATE11( UnityEngine.ParticleSystem ps,  UnityEngine.ParticleSystemTriggerEventType type,  System.Collections.Generic.List<UnityEngine.ParticleSystem.Particle> particles);
		
		delegate int __GEN_DELEGATE12( UnityEngine.ParticleSystem ps,  UnityEngine.ParticleSystemTriggerEventType type,  System.Collections.Generic.List<UnityEngine.ParticleSystem.Particle> particles, out  UnityEngine.ParticleSystem.ColliderData colliderData);
		
		delegate void __GEN_DELEGATE13( UnityEngine.ParticleSystem ps,  UnityEngine.ParticleSystemTriggerEventType type,  System.Collections.Generic.List<UnityEngine.ParticleSystem.Particle> particles,  int offset,  int count);
		
		delegate void __GEN_DELEGATE14( UnityEngine.ParticleSystem ps,  UnityEngine.ParticleSystemTriggerEventType type,  System.Collections.Generic.List<UnityEngine.ParticleSystem.Particle> particles);
		
		delegate UnityEngine.PhysicsScene __GEN_DELEGATE15( UnityEngine.SceneManagement.Scene scene);
		
		delegate UnityEngine.PhysicsScene2D __GEN_DELEGATE16( UnityEngine.SceneManagement.Scene scene);
	    ...
	    static InternalGlobals()
		{
		    extensionMethodMap = new Dictionary<Type, IEnumerable<MethodInfo>>()
			{
				...
				{typeof(UnityEngine.ParticleSystem), new List<MethodInfo>(){
				  ...
				  new __GEN_DELEGATE8(UnityEngine.ParticlePhysicsExtensions.GetSafeCollisionEventSize)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE9(UnityEngine.ParticlePhysicsExtensions.GetCollisionEvents)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE10(UnityEngine.ParticlePhysicsExtensions.GetSafeTriggerParticlesSize)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE11(UnityEngine.ParticlePhysicsExtensions.GetTriggerParticles)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE12(UnityEngine.ParticlePhysicsExtensions.GetTriggerParticles)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE13(UnityEngine.ParticlePhysicsExtensions.SetTriggerParticles)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE14(UnityEngine.ParticlePhysicsExtensions.SetTriggerParticles)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				...
				{typeof(UnityEngine.SceneManagement.Scene), new List<MethodInfo>(){
				  ...
				  new __GEN_DELEGATE15(UnityEngine.PhysicsSceneExtensions.GetPhysicsScene)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE16(UnityEngine.PhysicsSceneExtensions2D.GetPhysicsScene2D)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
